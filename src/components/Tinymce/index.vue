...
import { baseUrl as baseURL } from '@/config/url'
    ...
    initTinymce() {
      ...
      window.tinymce.init({
        ...
        images_upload_handler: function (blobInfo, succFun, failFun) {
          ...
          axios.post(baseURL+'/fastDfsUtil/uplodeFile', formData, config)
          .then(res => {
            if(res.data.code === 200){
              succFun(res.data.data.Url)
            }else{
              failFun(res.data.msg)
            }
          })
        },
        ...
        setup(editor) {
          ...
          editor.on('blur', function(e){
            _this.dispatch('ElFormItem', 'el.form.blur', [_this.value])
          })
        },
